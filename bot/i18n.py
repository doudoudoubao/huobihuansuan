...
ZH: dict[str, str] = {
    ...
    "stale_warn": "数据源连不上，已 {ago} 没刷新成功",
    "daily_source": "{sources} · 每日更新 · {when}报价",
    ...
    "settings_names": "显示货币中文名：<b>{state}</b>",
...
EN: dict[str, str] = {
    ...
    "stale_warn": "provider unreachable, no successful refresh for {ago}",
    "daily_source": "{sources} · daily · quoted {when}",
    ...
    "settings_names": "Show currency names: <b>{state}</b>",
